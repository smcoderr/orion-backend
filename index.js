...
const productImageUpload = multer({
  storage: multer.diskStorage({
    ...
    filename: (req, file, cb) => {
      cb(null, img.fieldname + "_" + Date.now() + path.extname(img.originalname));
    }
  })
});
...
app.post("/addfittings",upload.single('file'), (req, res) => {
  ...
  const table = new addfittingsmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
...
app.get('/getupdatefittings/:id',(req,res)=>{
  const id= req.params.id;
  addfittingsmodel.findById({_id:id})
  .then(addfittings => res.json(addfittings))
  .catch(err=>res.json(err))
})
...
app.put("/update/:id", upload.single('file'), async (req, res) => {
  ...
  try {
    const updatedRecord = await addfittingsmodel.findByIdAndUpdate(
      idn,
      { productname: req.body.pname, description: req.body.desc, image: req.file.filename },
      { new: true }
    );
...
app.post('/registerFavoriteProduct', upload.single('file'), async (req, res) => {
  try {
    ...
    if (existingProduct) {
      ...
      return res.status(400).json({ success: false, error1: 'Product is already registered as a favorite' });
    }
...
const addelectroMechanicalmodel = mongoose.model('addelectroMechanical_tbl', addelectroMechanicalSchema);

app.post("/addelectroMechanical",upload.single('file'), (req, res) => {
  var pname = req.body.pname;
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addelectroMechanicalmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
...
//api for put update
app.put("/updateelectroMechanical/:id", upload.single('file'), async (req, res) => {
  const idn = req.params.id;
...
app.post("/addsafety",upload.single('file'), (req, res) => {
  ...
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addsafetymodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
app.get('/getSafetyProduct/:id',(req,res)=>{
  const id= req.params.id;
  addsafetymodel.findById({_id:id})
...
app.post("/addwelding",upload.single('file'), (req, res) => {
  ...
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addweldingmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
app.post("/addflanges",upload.single('file'), (req, res) => {
  ...
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addflangesmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
app.post("/addvalves",upload.single('file'), (req, res) => {
  ...
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addvalvesmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
app.get('/getValvesProduct/:id',(req,res)=>{
  const id= req.params.id;
  addvalvesmodel.findById({_id:id})
...
const addfastenersmodel = mongoose.model('addfasteners_tbl', addfastenersSchema);

app.post("/addfasteners",upload.single('file'), (req, res) => {
  var pname = req.body.pname;
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addfastenersmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
const addinstrumentationmodel = mongoose.model('addinstrumentation_tbl', addinstrumentationSchema);

app.post("/addinstrumentation",upload.single('file'), (req, res) => {
  var pname = req.body.pname;
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addinstrumentationmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
//api for put update
app.put("/updateinstrumentation/:id", upload.single('file'), async (req, res) => {
  const idn = req.params.id;
...
const addliftingTacklesmodel = mongoose.model('addliftingTackles_tbl', addliftingTacklesSchema);

app.post("/addliftingTackles",upload.single('file'), (req, res) => {
  var pname = req.body.pname;
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addliftingTacklesmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
//api for put update
app.put("/updateliftingTackles/:id", upload.single('file'), async (req, res) => {
  const idn = req.params.id;
...
app.post("/addfender",upload.single('file'), (req, res) => {
  ...
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addfendermodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
app.get('/getFenderProduct/:id',(req,res)=>{
  const id= req.params.id;
  addfendermodel.findById({_id:id})
...
const addelectricalmodel = mongoose.model('addelectrical_tbl', addelectricalSchema);

app.post("/addelectrical",upload.single('file'), (req, res) => {
  var pname = req.body.pname;
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addelectricalmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
app.get('/getElectricalProduct/:id',(req,res)=>{
  const id= req.params.id;
  addelectricalmodel.findById({_id:id})
  .then(addelectrical => res.json(addelectrical))
  .catch(err=>res.json(err))
})
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////
app.get("/getaddelectrical", (req, res) => {
  addelectricalmodel.find()
  .then(addelectrical => res.json(addelectrical))
  .catch(err=>res.json(err))
});
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
const addotherGeneralItemsmodel = mongoose.model('addotherGeneralItems_tbl', addotherGeneralItemsSchema);

app.post("/addotherGeneralItems",upload.single('file'), (req, res) => {
  var pname = req.body.pname;
  var desc = req.body.desc;
  var image=req.file.filename;
  const table = new addotherGeneralItemsmodel({ productname: pname, description: desc,image:image }); // Use pname and desc here
  table.save().then(() => {
    res.send({ "msg16": "success" });
  }).catch((err) => {
    res.status(500).send({ "msg16": "error", "error": err.message });
...
//api for put update
app.put("/updateotherGeneralItems/:id", upload.single('file'), async (req, res) => {
  const idn = req.params.id;
